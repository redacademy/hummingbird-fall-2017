...
<div id="primary" class="content-area page-action">
    <main id="main" class="site-main" role="main">
        ...
        <section class="width-content action-header">
            ...
            <p>
                <?php echo CFS()->get( 'action_header_content' ); ?></p>
        </section>
        ...
        <?php $fields=CFS()->get('front_page_volunteer_case', 2 ); if(isset($fields)): foreach ( $fields as $field ) : ?>

        <section class="width-content volunteer">
            <!-- Hi, I'm Paula! -->
            <div class="volunteer-img" style="background-image: url(<?php echo wp_get_attachment_image_src($field['front_page_volunteer_case_photo'], 'medium_large')[0] ?>);">

            </div>
            <div class="volunteer-text">
                <h2>Hi! I'm <?php echo $field['front_page_volunteer_case_name']; ?></h2>
                <p>
                    <?php echo $field[ 'front_page_volunteer_case_content']; ?>
                </p>
            </div>
        </section>
